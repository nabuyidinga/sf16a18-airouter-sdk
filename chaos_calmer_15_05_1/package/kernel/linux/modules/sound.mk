...
define KernelPackage/sound-soc-siflower-v1
  TITLE:=Siflower SoC sound support for sf-mm board v1
  KCONFIG:= \
	CONFIG_SND_SOC_ES7149 \
	CONFIG_SND_SOC_SFAX8_I2S \
	CONFIG_SND_SOC_SFAX8_MACHINE \
	CONFIG_SND_SOC_SFAX8_SPDIF=n \
	CONFIG_SND_SOC_SFAX8_SPDIF_MACHINE=n \
	CONFIG_SND_SOC_ES8316=n \
	CONFIG_SND_SOC_ES8388S=n \
	CONFIG_SND_SOC_ES7210=n \
	CONFIG_SND_SOC_SFAX8_PCM=n \
	CONFIG_SND_SOC_RT5631=n
  FILES:= \
	$(LINUX_DIR)/sound/soc/codecs/snd-soc-es7149.ko \
	$(LINUX_DIR)/sound/soc/siflower/sfax8_i2s.ko  \
	$(LINUX_DIR)/sound/soc/siflower/snd-soc-sfax8-machine.ko
  AUTOLOAD:=$(call AutoLoad,66,snd-soc-es7149 sfax8_i2s snd-soc-sfax8-machine)
  DEPENDS:=@TARGET_siflower +kmod-sound-soc-core
  $(call AddDepends/sound)
endef

define KernelPackage/sound-soc-siflower-v1/description
 support for the siflower soundcard
endef

$(eval $(call KernelPackage,sound-soc-siflower-v1))


define KernelPackage/sound-soc-siflower-v2
  TITLE:=Siflower SoC sound support for sf-mm board v2
  KCONFIG:= \
	CONFIG_SND_SOC_ES7149 \
	CONFIG_SND_SOC_SFAX8_I2S \
	CONFIG_SND_SOC_SFAX8_MACHINE \
	...
	CONFIG_SND_SOC_ES8316=n \
	CONFIG_SND_SOC_ES8388S=n \
	CONFIG_SND_SOC_ES7210 \
	CONFIG_SND_SOC_SFAX8_PCM \
	CONFIG_SND_SOC_RT5631=n \
	CONFIG_SND_SOC_AD82584F=n
  FILES:= \
	$(LINUX_DIR)/sound/soc/codecs/snd-soc-es7149.ko \
	$(LINUX_DIR)/sound/soc/siflower/sfax8_i2s.ko  \
	$(LINUX_DIR)/sound/soc/codecs/snd-soc-es7210.ko \
	$(LINUX_DIR)/sound/soc/siflower/snd-soc-sfax8-pcm.ko \
	$(LINUX_DIR)/sound/soc/siflower/snd-soc-sfax8-machine.ko
  AUTOLOAD:=$(call AutoLoad,66,snd-soc-es7149 sfax8_i2s snd-soc-es7210 snd-soc-sfax8-pcm snd-soc-sfax8-machine)
  DEPENDS:=@TARGET_siflower +kmod-sound-soc-core
  $(call AddDepends/sound)
endef

define KernelPackage/sound-soc-siflower-v2/description
 support for the siflower soundcard
endef
$(eval $(call KernelPackage,sound-soc-siflower-v2))

define KernelPackage/sound-soc-siflower-v5
  TITLE:=Siflower SoC sound support for sf-mm board v5
  KCONFIG:= \
	CONFIG_SND_SOC_SFAX8_I2S \
	CONFIG_SND_SOC_SFAX8_MACHINE \
	CONFIG_SND_SOC_SFAX8_SPDIF=n \
  ...
  FILES:= \
	...
	$(LINUX_DIR)/sound/soc/siflower/snd-soc-sfax8-pcm.ko \
	$(LINUX_DIR)/sound/soc/siflower/snd-soc-sfax8-machine.ko
  AUTOLOAD:=$(call AutoLoad,66,snd-soc-ad82584f sfax8_i2s snd-soc-es7210 snd-soc-sfax8-pcm snd-soc-sfax8-machine)
  DEPENDS:=@TARGET_siflower +kmod-sound-soc-core
  $(call AddDepends/sound)
endef

define KernelPackage/sound-soc-siflower-v5/description
 support for the siflower soundcard
endef
$(eval $(call KernelPackage,sound-soc-siflower-v5))
