#ifndef SF_MM_DUILITE_H__
#define SF_MM_DUILITE_H__
...
#define DUILITE_VERSION_TEXT "AISpeech DUILite SDK V" DUILITE_VERSION_STRING " " __DATE__ " " __TIME__
