...
#add for make evb && p10 use different kernel config
...
ifneq ($(findstring AIR001-V1,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_air001_v1 $(1)/config-default
endif

ifneq ($(findstring AIR001-V2,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_air001_v2 $(1)/config-default
endif

ifneq ($(findstring AIR001-V4,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_air001_v4 $(1)/config-default
endif

ifneq ($(findstring AIR001-V5,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_air001_v5 $(1)/config-default
endif
